    ...
    <div className="relative w-full" ref={containerRef}>
      <div className="flex items-center relative">
        <input
          ...
          className={cn(
            "bg-transparent border-none focus:ring-2 focus:ring-emerald-500/20 rounded px-2 py-1 w-full font-semibold transition-all outline-none pr-6 placeholder:text-slate-400 placeholder:font-normal",
            className
          )}
          title={title}
        />
